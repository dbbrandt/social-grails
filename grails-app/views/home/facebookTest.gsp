    ...
    <body>
        ...
        <script type="text/javascript">
			...
			function fb_getInviteFBML() {
			    var fbml = '<fb:request-form action="http://dev.precidix.com:8080/esmzone" method="POST" invite="true" type="ESMZone" content="Join ESMZone, the place for student athletes. Ask and answer questons and win prizes."><fb:multi-friend-selector showborder="false" bypass="cancel" cols=4 actiontext="Invite your friends to join ESMZone"/></fb:request-form>'
			    	return fbml;
			}
