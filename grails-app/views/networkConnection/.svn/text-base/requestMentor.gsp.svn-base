...
<html>
    <head>
        ...
        <g:set var="entityName" value="${message(code: 'requestMentor.label', default: 'Request a Mentor')}" />
    ...
    <body>
        <div class="body">
            ...
            <g:form action="requestMentor" method="post" >
                ...
                <div class="formField">
	               	<label for="message">Enter a brief comment to the Mentor:</label>
				</div>
				<br>
