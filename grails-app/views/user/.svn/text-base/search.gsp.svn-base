		...
		<div id="container" class="${containerClass}">
			<div id="left">
					<div class="box">
						...
						<input type="submit" value="Submit" class="hidden">
							...
							<g:else>
								<a href="${createLink(controller:'user', action:'register')}" title="Join ESMZone Today" class="submit right button">Join ESMZone Today</a>
							</g:else>
						</g:form>	
					</div><!-- end div.box -->
					...
					<g:if test="${request.user}">
						<div class="facebook">
							<div class="share">
								<a href="http://www.facebook.com/sharer.php?u=www.esmzone.com/esmzone&t=ESMZONE - Where Student Athletes Train to Lead" class="share-link"  target="_blank"></a>
							</div>
			...
			<g:if test="${request.user}">
				<div id="right">
					...
					<div id="search_ad_right">
						<script type="text/javascript"><!--
							google_ad_client = "ca-pub-4702516645654390";
							/* Logged in Search - Right Column */
							google_ad_slot = "2511342051";
							google_ad_width = 160;
			...
			<g:else>
				<div id="right" class="search-sidebar">
   				...
   				</div><!-- end of div#right.search-sidebar -->
			</g:else>
