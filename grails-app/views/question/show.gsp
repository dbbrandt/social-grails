            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="question.questionText.label" default="Question Text" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="question.responses.label" default="Responses" /></td>
